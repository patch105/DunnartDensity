...
#B - transient behavioural step-change
fit.site.D.B.g0.EX <- secr.fit(CH,
                    detectfn = 'EX',
                    buffer = 300,
                    model = list(D ~ site, g0 ~ B, sigma ~1), 
                    details = list(autoini = 4),
                    trace = FALSE, 
                    verify = F,
                    sessioncov = covariates)
...
fits <- secrlist(EX = fit.EX,
                 ...
                 site.D.B.g0 = fit.site.D.bk.g0.EX)
