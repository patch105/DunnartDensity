...
plot <- ggplot(data.frame(m), aes(x = m)) +
  geom_histogram(breaks = seq(0, 450, 30), fill = "grey", color = "black", alpha = 0.7) +
  labs(x = "Movement (m)", y = "Frequency", title = "") +
  theme_classic()

# ggsave(plot = plot , filename = "hist_movements.png", w = 20, h = 11, units = "cm", dpi = 600, device = "png" )
